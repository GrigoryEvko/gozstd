// Package gozstd provides Enhanced Dictionary Training with COVER algorithms.
//
// OVERVIEW:
// Enhanced dictionary training uses sophisticated algorithms like COVER and FastCover
// to build better dictionaries compared to the basic training. These algorithms
// analyze patterns in the training corpus more effectively and can automatically
// optimize parameters for best compression ratio.
//
// ALGORITHMS:
// - COVER: High-quality dictionary training algorithm that finds optimal segments
// - FastCover: Faster version of COVER with similar quality
// - Legacy: Older algorithm for compatibility
//
// PARAMETER OPTIMIZATION:
// The optimization functions automatically try many parameter combinations and
// select the best ones based on compression ratio testing on the training corpus.
//
// USAGE RECOMMENDATIONS:
// - Use FastCover for most cases (good balance of speed and quality)
// - Use COVER when maximum quality is needed and training time is not critical  
// - Use optimization functions unless you know optimal parameters for your data
// - Provide 1000+ samples with total size 100x the target dictionary size
//
// EXAMPLE:
...
//       D: 8,     // D-mer size
//   }
//   dict, err := BuildDictFastCover(samples, 100*1024, params)
//   if err != nil {
//       log.Fatal(err)
//   }
package gozstd
